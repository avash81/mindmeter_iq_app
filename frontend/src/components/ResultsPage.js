...
const ResultsPage = () => {
  ...
  const handleDownloadCertificate = async (e) => {
    ...
    try {
      ...
      link.setAttribute(
        "download",
        `TestIQ_Certificate_${name.replace(/\s+/g, "_")}.pdf`
      );
  ...
  return (
    <div className="results-container">
      <div className="results-card">
        ...
        <p
          style={{ fontSize: "1.1rem", color: "#6b7280", marginBottom: "1rem" }}
        >
        ...
        <div className="iq-score-display">
          ...
          <div className="iq-score" data-testid="iq-score">
            {result.iq_score}
          </div>
        </div>
        ...
        <div className="score-details">
          ...
          <div className="score-row">
            ...
            <span className="score-value" data-testid="accuracy">
              {percentage}%
            </span>
          </div>
        </div>
        ...
        <div className="results-disclaimer" data-testid="results-disclaimer">
          This is an IQ estimate based on your test performance. Results are for
